...
NUM_EPISODES = 12000/10  # Number of episodes the agent plays
...
class Agent():
    ...
    def build_network(self):
        model = Sequential()
        model.add(Convolution2D(32, 8, 8, subsample=(4, 4), activation='relu',border_mode='same', input_shape=(STATE_LENGTH, FRAME_WIDTH, FRAME_HEIGHT,)))
